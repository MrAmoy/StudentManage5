...
<body bgcolor="CCCFFF">
	...
	%>
	<center>
		<br> <br> <br> <br> <br> <br> <h3>请选择要删除的学生</h3>
		<table border="0" bgcolor="CCCEEE" width="600">
			...
			<tr align="center">
				...
				<td><a href="deleteStudentCheck_jsp?id=<%=i %>"><font color="red">删除</font></a></td>
			</tr>
			<%
				}
			%>
		...
		<h4>
			<% if(pagebean.getCurPage() == 1) { %>
				首页&nbsp;&nbsp;&nbsp;&nbsp;上一页&nbsp;&nbsp;&nbsp;&nbsp;
			<% } else { %>
				<a href="deleteStudent_jsp?curpage=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="deleteStudent_jsp?curpage=<%=pagebean.getCurPage() - 1%>">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<% } if(pagebean.getCurPage() == pagebean.getMaxPage()) { %>
				下一页&nbsp;&nbsp;&nbsp;&nbsp;页尾
			<% } else { %>
				<a href="deleteStudent_jsp?curpage=<%=pagebean.getCurPage() + 1%>">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="deleteStudent_jsp?curpage=<%=pagebean.getMaxPage()%>">页尾</a>
			<% } %>
		</h4>
	</center>
</body>
